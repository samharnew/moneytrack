...
import pandas as pd
import numpy as np
from moneytrack import BalanceTransfers, BalanceUpdates, DailyAccountHistory, MoneyData, MODULE_PATH
import logging
...
class TestCore(unittest.TestCase):
    ...
    def test_get_daily_balances(self):
        ...
        hist = DailyAccountHistory.from_updates_and_transfers(balance_transfers=bal_trans,
    ...
    def test_daily_summary(self):
        ...
        hist = DailyAccountHistory.from_updates_and_transfers(balance_transfers=bal_trans, balance_updates=balance_updates, account_key="1")
        print(hist.get_df())
